<#
    .DESCRIPTION
        A runbook which Stops VM's that are tagged with key of Priority and Value of 1 using the Run As Account (Service Principal)
...
Start-AzureRmAutomationRunbook -Name Shutdown-VMs_Priority0 -AutomationAccountName OPSMG01-OMS-Automation -ResourceGroupName opsmg01-oms
